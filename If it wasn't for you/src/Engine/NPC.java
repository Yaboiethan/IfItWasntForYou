...
public class NPC extends GameObject
{
    ...
    private NPCMoveEvent moveEvent;
    ...
    public NPC(Position startingPos)
    {
        ...
        testEvent = new TextboxChoiceEvent(new String[]{"Yes", "No"});
        testEvent.setActivationLine(2);
        ...
        //Set up Move event
        moveEvent = new NPCMoveEvent(this, Position.Direction.SOUTH, 50);
    ...
    public void Update() //To be run every frame
    {
        ...
        {
            if(testEvent.textbox.getChoice() == 0)
            {
                moveEvent.setActivationLine(3);
            }
            testEvent = null; //Remove testEvent
        }

        if(moveEvent != null && !moveEvent.getIfDone())
        {
            moveEvent.Update();
        }
