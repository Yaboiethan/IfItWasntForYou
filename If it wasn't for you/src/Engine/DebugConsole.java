...
public class DebugConsole extends JFrame
{
    ...
    private final String[] commands = {"!help", "!toggleColliders", "!toggleMouseCoors", "!showCenter",
            "!togglePos", "!toggleAnim", "!showTarotDeck", "!toggleTextboxVisuals", "!showBlackScreen", "!forceBattle"};
    private final String[] descriptions = {"Displays all commands", "Toggles Engine.Collider visuals",
            ...
            "Show/Hide Engine.Textbox visual components", "Show/Hide Black Screen", "Force a battle scene"};
    ...
    private void EnactCommand(int index)
    {
        switch(index)
        {
            ...
            case 5: //Engine.Animator Information
                SHOW_ANIMATOR_INFO = !SHOW_ANIMATOR_INFO;
                AddTextToView("Engine.Animator Info = " + SHOW_ANIMATOR_INFO);
                break;
            ...
            case 7: //Override textbox visuals
                ...
                AddTextToView("Engine.Textbox Override = " + OVERRIDE_TEXTBOX_VISUALS);
                break;
            ...
            case 9: //Force battle
                GamePanel.toggleBattleScreen(!GameFrame.inBattle);
                AddTextToView("Battle Forced " + GameFrame.inBattle);
                break;
        }
    }
}
