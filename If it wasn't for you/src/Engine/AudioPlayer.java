package Engine;/*
Engine.AudioPlayer components do just that, play audio. They store audio files and play them on demand whenever the Engine.GameObject
...
public class AudioPlayer
{
    ...
    public void loadClip(String fileName)
    {
        ...
        {
            GameRunner.debugConsole.AddTextToView("Engine.AudioPlayer could not load " + fileName + "\n  " + e.getMessage());
        }
