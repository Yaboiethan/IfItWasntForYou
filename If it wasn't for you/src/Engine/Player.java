...
The Engine.Player class is the vessel of the player's inputs, and respond directly to what they input
    - Movement
...
public class Player extends GameObject
{
    ...
    public void InitializeAnimator()
    {
        ...
        //Initialize Object
        anim = new Animator(this, "Engine.Player");
    ...
    public void setMovement(boolean b) //Used to disable/enable all movement at once (IE: Engine.Textbox)
    {
        mNorth = b;
        mEast = b;
        mSouth = b;
